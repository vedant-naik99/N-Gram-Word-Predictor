...
bi_words <- readRDS("projectData/bi_words_fast.rds")
tri_words  <- readRDS("projectData/tri_words_fast.rds")
quad_words <- readRDS("projectData/quad_words_fast.rds")
